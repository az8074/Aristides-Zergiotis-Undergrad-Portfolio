...
### 3. [MATLAB MNA Circuit Simulator](./projects/mna-simulator/README.md)
A Modified Nodal Analysis (MNA) circuit simulator built in MATLAB, capable of solving linear circuit equations for arbitrary circuit topologies. *(Full write-up coming soon)*

---

*More projects and documentation will be added as this portfolio grows.*
